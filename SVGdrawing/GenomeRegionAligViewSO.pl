...
#
# Installation: conda install -c bioconda perl-svg bedops multiz lastz
#
...
$tba ||='';
$bedops ||='';
$svg2xxx ||="$FindBin::Bin/svg2xxx_release/"; #default located in the same directory of this scrit
$Tbed ||='NA';
$Qbed ||='NA';
